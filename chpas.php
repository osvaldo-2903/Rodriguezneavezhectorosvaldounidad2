...
if (isset($_POST['recuperar'])) {
    ...
    $sql = "SELECT id, email FROM usuarios WHERE telefono = :telefono";
    ...
    if ($stmt->rowCount() > 0) {
        ...
        $message = $twilio->messages
            ->create(
                "whatsapp:+5218444995276", // Número del destinatario
                array(
                ...
                <div style="width: 30%; height: 80%; background-color: white; border-radius: 20px;">
                    ...
                    <div class="formulario" style="width: 85%; height: 100%; margin: auto;">
                        ...
                        <form method="post">
                            <div class="uk-margin">
                                <div class="uk-inline" style="width: 120%;">
                                    ...
                                    <span class="uk-form-icon" uk-icon="icon: user"
                                        style="color: rgb(31, 227, 31);"></span>
                                    <input class="uk-input" type="text" aria-label="Not clickable icon"
                                        placeholder="Numero telefonico" id="telefono" name="telefono" required>
                                </div>
                            </div>
                            <div class="uk-margin">
                                <div class="uk-inline" style="width: 120%;">
                            ...
                            <button class="uk-button uk-button-secondary uk-width-1-1" name="recuperar"
                                type="submit">Recuperar contraseña</button>
                            <br>
                            <br>
                            <br>
                            <h4 style="color: black; font-family: arial: font-size: 20px:">Nota: Se te enviara un codigo
                                a
                                tu WhatsApp con tu numero registrado.</h4>
                        </form>
                ...
                <div style="width: 30%; height: 80%; background-color: white; border-radius: 20px;">
                    ...
                    <div class="formulario" style="width: 85%; height: 100%; margin: auto;">
                        ...
                        <form method="post">
                            ...
                            <br>
                            <h4 style="color: black; font-family: arial: font-size: 20px:">Nota: Se te enviara un codigo
                                a tu WhatsApp con tu numero registrado.</h4>
                        </form>
